...
void selectionner(int choix){
    switch(choix){
        ...
        case 3:
            ...
            break;
        case 4:
            printf("Vous avez choisi un Chocolat au lait . Merci de pays 30 DH !!! \n");
            return 35;
            break;
        case 5:
...
void Afficher_rendu(int rendu){
    if(rendu >= 50){
        printf("%d piece de 50 DH ",rendu/50);
        rendu = rendu % 50;
    }
    if(rendu >= 20){
        printf("%d piece de 20 DH ",rendu/20);
        rendu = rendu % 20;
    }
    if(rendu >= 10){
        printf("%d piece de 10 DH ",rendu/10);
        rendu = rendu % 10;
    }
    if(rendu >= 5){
        printf("%d piece de 5 DH ",rendu/5);
        rendu = rendu % 5;
    }
}*/
